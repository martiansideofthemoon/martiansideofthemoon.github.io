...
This puts NLP inference APIs at the risk of being "stolen" via a model extraction attack --- where malicious users spam APIs with queries and uses the outputs to reconstruct a copy of the model.
