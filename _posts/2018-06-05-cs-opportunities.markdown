...
* Competitions
   * [ACM ICPC](https://icpc.baylor.edu/) - This is a popular contest in which a number of CS students from IIT Bombay take part (and do well!). "Competitive Coding" in its true sense, preparation for this contest requires significant comfort with data structures and a lot of practice. [Here](https://wncc-iitb.org/wiki/index.php/Competitive_Programming) is a beginner's guide.
   * [Build the Shield](https://news.microsoft.com/en-in/tag/build-the-shield/) (*A Capture the Flag Competition*) - A national level computer security competition which is also quite popular among CS undergraduates at IIT Bombay. Contact the [CSE Cybersecurity Club](https://www.facebook.com/groups/csec.iitb/) for more details.
